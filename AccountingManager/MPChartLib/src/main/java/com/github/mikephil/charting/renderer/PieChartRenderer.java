...
public class PieChartRenderer extends DataRenderer {
    ...
    protected void drawHole(Canvas c) {
        ...
        if (mChart.isDrawHoleEnabled() && mBitmapCanvas != null) {
            ...
            if (centerBackground != null) {
                mBitmapCanvas.drawBitmap(centerBackground, mChart.getWidth() / 2 - centerBackground.getWidth() / 2,
                        mChart.getHeight() / 2 - centerBackground.getHeight() / 2,
                        mHolePaint);
            }
    ...
    private Bitmap centerBackground = null;

    public void setCenterBackImg(Bitmap bitmap) {
        this.centerBackground = bitmap;
    }
